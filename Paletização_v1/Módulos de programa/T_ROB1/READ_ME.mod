...
! Module description
!===========================================
! Modulo apenas com descritivos, observacoes e afins...
! da celula sem funcionalidade nenhuma.
!===========================================
    ...
    !*** NUMERICAS
    !* nDis_Floor2ExitPick = Distancia em Z do ponto de saida da pega na esteira, até aonde sera o plano
    !da primeira camada do palete
